...
const ModalSignInInfo = () => {
    return (
        <Text type={TextSizes.SECONDARY} className={styles.info}>
            <SmallLink href={'https://app.subsocial.network/legal/privacy'}>Privacy Policy</SmallLink>
            <span/>
            <SmallLink href={'https://app.subsocial.network/legal/privacy'}>Terms of Use</SmallLink>
        </Text>
    )
}
