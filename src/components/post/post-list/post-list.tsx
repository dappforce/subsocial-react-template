...
import { InnerLoadMoreFn, loadMoreValuesArgs } from '../../../models/infinity-scroll'
...
const loadMorePostsFn = async (loadMoreValues: loadMoreValuesArgs) => {
    ...
    await dispatch(fetchPosts({api, ids: postIds, reload: false, withReactionByAccount: myAddress, visibility}))
...
const PostList: FC<PostListProps> = ({
    ...
    useEffect(() => {
        ...
        isMounted && loadSuggestedPostIds(api, ids)
            .then(ids => {
